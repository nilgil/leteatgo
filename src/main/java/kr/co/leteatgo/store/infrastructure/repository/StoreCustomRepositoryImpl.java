...
import static com.querydsl.spatial.locationtech.jts.JTSGeometryExpressions.*;
import static kr.co.leteatgo.store.application.GeoFactory.*;
import static kr.co.leteatgo.store.domain.store.entity.QStore.*;
import static kr.co.leteatgo.store.domain.store.entity.QStoreFoodType.*;
import static kr.co.leteatgo.store.domain.store.enums.StoreSearchSort.*;
