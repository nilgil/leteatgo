...
public class AuthCodeServiceImpl implements AuthCodeService {
	...
	public AuthCodeServiceImpl(AuthCodeRepository authCodeRepository, SmsService smsService,
	...
	public void sendAuthCode(String phoneNumber) {
		...
		smsService.sendSms(new SendSmsRequest(message.phoneNumbers(), message.content()));
